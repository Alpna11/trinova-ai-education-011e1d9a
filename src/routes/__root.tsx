...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Edunova — AI tutor for every chapter" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Edunova — AI tutor for every chapter" },
      {
        ...
        content:
          "Bilingual AI tutoring, step-by-step doubt solving, quizzes and progress tracking for students, teachers and parents.",
      },
